...
Language model sampling is non-deterministic. Even at a fixed temperature, providers do not guarantee byte-identical output across calls, and reasoning models (the GLM-5.3-Flash default, and any thinking-mode model) vary the most because their internal reasoning is itself sampled.
