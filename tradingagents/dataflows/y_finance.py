...
# Shared indicator catalog: stockstats key -> (usage description). Single source
# of truth so every vendor implementation of `get_indicators` accepts the same
# indicator names and returns the same guidance text to the analyst.
INDICATOR_DESCRIPTIONS: dict[str, str] = {
    ...
    "macdh": (
        ...
        "Tips: Can be volatile; complement with additional filters for fast-moving markets."
    ),
    # Momentum Indicators
    "rsi": (
